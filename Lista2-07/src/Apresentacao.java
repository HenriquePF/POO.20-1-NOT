...
public class Apresentacao extends JFrame {
	...
	public Apresentacao() {
		...
		btnMultiplicar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				double res = atual.multiplica(outro);
				textArea.append("\nVetor multiplicador = "+outro.exibe());
				textArea.append("\nMultiplicação = "+res);
			}
		});
		...
		btnDividir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				VetorDeReais resultado = atual.divide(outro);
				textArea.append("\nVetor divisor = "+outro.exibe());
				textArea.append("\nResultado = "+resultado.exibe());
			}
		});
		...
		btnQuantosPares.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textArea.append("\nQuantos pares? "+atual.getQtdePares());
			}
		});
