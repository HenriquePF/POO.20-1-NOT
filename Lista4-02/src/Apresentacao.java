...
public class Apresentacao extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jComboBox1.setModel(new DefaultComboBoxModel(new String[] { "Universit\u00E1rio", "Ensino M\u00E9dio" }));
		...
		jComboBox2.setModel(new DefaultComboBoxModel(new String[] { "1", "2", "3" }));
								...
								layout.createSequentialGroup().addContainerGap().addGroup(
										layout.createParallelGroup(Alignment.LEADING)
												...
												.addComponent(jButton2).addComponent(jScrollPane1,
														GroupLayout.DEFAULT_SIZE, 535, Short.MAX_VALUE)))
						.addGroup(layout.createSequentialGroup().addGap(22).addGroup(layout
								...
								.addGroup(layout.createParallelGroup(Alignment.LEADING, false)
										.addGroup(layout.createSequentialGroup().addComponent(jLabel2)
												.addPreferredGap(ComponentPlacement.RELATED).addComponent(jTextField2))
								...
								.addGroup(layout.createSequentialGroup().addComponent(jLabel3)
										...
										.addComponent(jComboBox2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE)
										.addGap(45).addGroup(
												layout.createParallelGroup(Alignment.LEADING).addComponent(jButton1)
		...
		layout.setVerticalGroup(layout.createParallelGroup(Alignment.LEADING).addGroup(layout.createSequentialGroup()
				...
				.addGroup(layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel3)
						...
						.addComponent(jTextField3, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addComponent(jLabel5).addComponent(jComboBox3, GroupLayout.PREFERRED_SIZE,
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try {
			if (jComboBox1.getSelectedIndex() == 0) { // AlunoUniversitário
				...
				aluno = new AlunoEnsinoMedio(jTextField1.getText(), LocalDate.parse(jTextField2.getText(), formatter),
